          ...
          <div className='grow flex flex-col justify-center'>
            <div>
              ...
              <p className='text-md mx-4'>
                ...
                - I&apos;m currently <span className='text-[#d17b56]'>22 years old</span> and finishing my studies in <span className='text-[#d17b56]'>Computer Engineering</span> 💻. <br/><br/>
                ...
                - I&apos;m a big fan of traveling <span className='text-[#d17b56]'>all around the world</span> 🌍 - I&apos;ve been fortunate enough to visit <span className='text-[#d17b56]'>11 countries</span> so far! <br/> <br/>
                - I have participated in <span className='text-[#d17b56]'>2 Erasmus+ TC and 5 YE</span>! 🇪🇺  <br/><br/>
                - I have led the organization of a YE on the topic of <span className='text-[#d17b56]'>Emotional Intelligence</span> 📝 <br/><br/>
