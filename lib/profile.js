...
export const profile = {
  ...
  headline: 'I put AI agents into production — and measure whether they work.',
  ...
  // Home "Now" section
  nowBody:
    'Head of Software at Innogando since 2026 — agrotech/IoT, maker of RUMI, GPS collars used by thousands of farmers. I joined in July 2022 as an engineer, when the whole company was ten people; today I lead a nine-person team across product, data and infrastructure, and I still write code. Outside Innogando I am building Aurasia, an AI WhatsApp receptionist for dental clinics that is validating in the market, and I co-founded Trazea, food traceability for hospitality, live in both app stores.',
...
export const metaDescription = `AI agents in production — built end to end and measured. ${identityLine}.`
