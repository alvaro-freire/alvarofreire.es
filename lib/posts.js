...
export function formatDate(date) {
  if (!date) return ''
  // Frontmatter dates are calendar days ('YYYY-MM-DD'), which Date parses
  // as UTC midnight — format in UTC too, or a build server west of
  // Greenwich prints the previous day.
